...
public class PieceOperatorSum extends PieceOperator {
	...
	public @NotNull IntervalNumber evaluate() throws SpellCompilationException {
		return this.<Number, IntervalNumber>getNonNullParamEvaluation(num1).add(getNonNullParamEvaluation(num2)).add(getParamEvaluationeOrDefault(num3, IntervalNumber.zero));
	}
