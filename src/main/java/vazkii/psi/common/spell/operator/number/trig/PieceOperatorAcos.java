...
public class PieceOperatorAcos extends PieceOperator {

	SpellParam<Number> num;

	public PieceOperatorAcos(Spell spell) {
		super(spell);
	}
	...
	public @NotNull IntervalNumber evaluate() throws SpellCompilationException {
		...
		return iv.clamp(IntervalNumber.fromRange(-1, 1)).reversingMonotonicMap(Math::acos);
	}
