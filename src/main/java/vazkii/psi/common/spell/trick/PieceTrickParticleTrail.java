...
public class PieceTrickParticleTrail extends PieceTrick {
	...
	public Object execute(SpellContext context) throws SpellRuntimeException {
		...
		MessageRegister.HANDLER.send(PacketDistributor.DIMENSION.with(() -> context.caster.getEntityWorld().getRegistryKey()), new MessageParticleTrail(pos.toVec3D(), dir.toVec3D(), length, time, PsiAPI.getPlayerCAD(context.caster)));
		return null;
	}
}
