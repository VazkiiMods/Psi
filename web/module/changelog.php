...
<?php
	...
	echo('<div class="btn-group"><button type="button" class="btn btn-material-lightblue dropdown-toggle" data-toggle="dropdown">Version Index <span 
class="caret"></span></button><ul class="dropdown-menu">');
	...
	function add_buttons() {
		...
		$changelog .= "<br><div class='btn btn-flat btn-material-teal hashlink'>Back to top</div><a href='dl.php?file=Psi-$href_version.jar'><div class='btn btn-flat btn-material-lightblue'>Download</div></a>";
	}
