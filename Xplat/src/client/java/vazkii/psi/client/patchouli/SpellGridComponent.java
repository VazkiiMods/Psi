...
public class SpellGridComponent implements ICustomComponent {
	...
	public void render(GuiGraphics graphics, IComponentRenderContext context, float pticks, int mouseX, int mouseY) {
		...
		graphics.drawString(Minecraft.getInstance().font, I18n.get("psimisc.name"), 7, 171, 0xFFFFFF, true);
		graphics.drawString(Minecraft.getInstance().font, spellName, 44, 170, 0xFFFFFF, true);
		...
		SpellPieceRenderer.draw(grid, graphics.pose(), buffer, 0xF000F0);
		buffer.endBatch();
