...
public class PsiBlockTagProvider extends IntrinsicHolderTagsProvider<net.minecraft.world.level.block.Block> {

	public PsiBlockTagProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider) {
	...
	protected void addTags(HolderLookup.Provider pProvider) {
		...
		tag(ModTags.Blocks.STORAGE_BLOCKS).add(ModBlocks.psimetalBlock.get());
		tag(ModTags.Blocks.STORAGE_BLOCKS).add(ModBlocks.psigemBlock.get());
		tag(ModTags.Blocks.STORAGE_BLOCKS).add(ModBlocks.psimetalEbony.get());
		tag(ModTags.Blocks.STORAGE_BLOCKS).add(ModBlocks.psimetalIvory.get());

		tag(BlockTags.AIR).add(ModConjuredBlock.BLOCK.get());
