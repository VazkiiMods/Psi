...
public class ItemFlashRing extends Item implements FlashRingSpellTarget {
	...
	public @NotNull InteractionResultHolder<ItemStack> use(@NotNull Level level, Player player, @NotNull InteractionHand usedHand) {
		...
		if(isSneaking && level.isClientSide) {
			PsiClientRuntime.openFlashRing(held);
	...
	@Override
	public void setEditedSpell(Player player, ItemStack stack, Spell spell) {
		ISpellAcceptor acceptor = PsiCapabilities.spellAcceptor(stack);
		if(acceptor != null) {
			acceptor.setSpell(player, spell);
		}
	}

	public static class SpellAcceptor implements ISpellAcceptor {
