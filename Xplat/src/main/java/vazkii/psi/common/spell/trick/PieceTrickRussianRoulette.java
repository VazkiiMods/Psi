...
public class PieceTrickRussianRoulette extends PieceTrick {
	...
	public Object execute(SpellContext context) {
		...
		boolean updateLoopcast = (stack.getItem() instanceof ICAD) && (context.castFrom == PsiPlayerData.get(context.caster).loopcastHand);
		...
		if(updateLoopcast) {
			PsiPlayerData.get(context.caster).lastTickLoopcastStack = stack.copy();
		}
		return null;
	}
