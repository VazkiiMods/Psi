...
public class LibResources {
	...
	public static final ResourceLocation PATCHOULI_BOOK = PsiAPI.location("encyclopaedia_psionica");

	public static final ResourceKey<DamageType> PSI_OVERLOAD = ResourceKey.create(Registries.DAMAGE_TYPE, PsiAPI.location("psi_overload"));
	...
	public static final ResourceLocation MODEL_PSIMETAL_EXOSUIT = PsiAPI.location(PREFIX_MODEL + "psimetal_exosuit.png");
	public static final ResourceLocation MODEL_PSIMETAL_EXOSUIT_SENSOR = PsiAPI.location(PREFIX_MODEL + "psimetal_exosuit_sensor.png");
