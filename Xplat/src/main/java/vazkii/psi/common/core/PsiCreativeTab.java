...
import vazkii.psi.common.platform.PsiCreativeTabs;
...
public class PsiCreativeTab {
	...
	public static final ResourceKey<CreativeModeTab> PSI_CREATIVE_TAB = ResourceKey.create(
			Registries.CREATIVE_MODE_TAB, PsiAPI.location("creative_tab"));
	public static final RegistryEntry<CreativeModeTab> CREATIVE_TAB = PsiRegistries.register(
			BuiltInRegistries.CREATIVE_MODE_TAB, PSI_CREATIVE_TAB.location(), PsiCreativeTab::create);

	public static void register() {}

	private static CreativeModeTab create() {
		CreativeModeTab.Builder builder = PsiCreativeTabs.builder()
